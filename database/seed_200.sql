...
-- =============================================
INSERT INTO MOVIMENTOCONTAS (tipo, id_fornecedor, id_faturado, id_classificacao, valor_total, data_emissao, ativo) VALUES
-- APAGAR (60) —-----------------------------------------------------------
('APAGAR',  1,  31,  1,   5800.00, '2024-01-10', TRUE),
('APAGAR',  2,  32,  2,   1250.50, '2024-01-15', TRUE),
('APAGAR',  3,  33,  3,   3400.00, '2024-01-22', TRUE),
('APAGAR',  4,  34,  4,   2100.75, '2024-02-03', TRUE),
('APAGAR',  5,  35,  5,    890.00, '2024-02-10', TRUE),
('APAGAR',  6,  36,  6,   6750.00, '2024-02-18', TRUE),
('APAGAR',  7,  37,  7,  12000.00, '2024-02-25', TRUE),
('APAGAR',  8,  38,  8,   4300.00, '2024-03-05', TRUE),
('APAGAR',  9,  39,  9,   7800.50, '2024-03-12', TRUE),
('APAGAR', 10,  40, 10,   2200.00, '2024-03-20', TRUE),
('APAGAR', 11,  31, 11,   9500.00, '2024-03-28', TRUE),
('APAGAR', 12,  32, 12,   1800.25, '2024-04-05', TRUE),
('APAGAR', 13,  33, 13,   3200.00, '2024-04-12', TRUE),
('APAGAR', 14,  34, 14,   5600.75, '2024-04-19', TRUE),
('APAGAR', 15,  35,  1,   4100.00, '2024-04-26', TRUE),
('APAGAR', 16,  36,  2,   2750.50, '2024-05-03', TRUE),
('APAGAR', 17,  37,  3,  11200.00, '2024-05-10', TRUE),
('APAGAR', 18,  38,  4,   6900.00, '2024-05-17', TRUE),
('APAGAR', 19,  39,  5,   1350.00, '2024-05-24', TRUE),
('APAGAR', 20,  40,  6,   8400.00, '2024-05-31', TRUE),
('APAGAR',  1,  31,  7,  15000.00, '2024-06-07', TRUE),
('APAGAR',  2,  32,  8,   3600.00, '2024-06-14', TRUE),
('APAGAR',  3,  33,  9,   2900.25, '2024-06-21', TRUE),
('APAGAR',  4,  34, 10,   7200.00, '2024-06-28', TRUE),
('APAGAR',  5,  35, 11,   4800.50, '2024-07-05', TRUE),
('APAGAR',  6,  36, 12,   1600.00, '2024-07-12', TRUE),
('APAGAR',  7,  37, 13,  10500.00, '2024-07-19', TRUE),
('APAGAR',  8,  38, 14,   3100.75, '2024-07-26', TRUE),
('APAGAR',  9,  39,  1,   5400.00, '2024-08-02', TRUE),
('APAGAR', 10,  40,  2,   2000.00, '2024-08-09', TRUE),
('APAGAR', 11,  31,  3,   8900.00, '2024-08-16', TRUE),
('APAGAR', 12,  32,  4,   4500.25, '2024-08-23', TRUE),
('APAGAR', 13,  33,  5,   6300.00, '2024-08-30', TRUE),
('APAGAR', 14,  34,  6,   1950.50, '2024-09-06', TRUE),
('APAGAR', 15,  35,  7,  13500.00, '2024-09-13', TRUE),
('APAGAR', 16,  36,  8,   7100.00, '2024-09-20', TRUE),
('APAGAR', 17,  37,  9,   2800.75, '2024-09-27', TRUE),
('APAGAR', 18,  38, 10,   5200.00, '2024-10-04', TRUE),
('APAGAR', 19,  39, 11,   3700.00, '2024-10-11', TRUE),
('APAGAR', 20,  40, 12,   9100.50, '2024-10-18', TRUE),
('APAGAR',  1,  31, 13,   4200.00, '2024-10-25', TRUE),
('APAGAR',  2,  32, 14,   6700.25, '2024-11-01', TRUE),
('APAGAR',  3,  33,  1,  11800.00, '2024-11-08', TRUE),
('APAGAR',  4,  34,  2,   2450.00, '2024-11-15', TRUE),
('APAGAR',  5,  35,  3,   8200.75, '2024-11-22', TRUE),
('APAGAR',  6,  36,  4,   3900.00, '2024-11-29', TRUE),
('APAGAR',  7,  37,  5,  16000.00, '2024-12-06', TRUE),
('APAGAR',  8,  38,  6,   5100.50, '2024-12-13', TRUE),
('APAGAR',  9,  39,  7,   2600.00, '2024-12-20', TRUE),
('APAGAR', 10,  40,  8,   7800.00, '2024-12-27', TRUE),
('APAGAR', 11,  31,  9,   4400.25, '2025-01-03', TRUE),
('APAGAR', 12,  32, 10,   9600.00, '2025-01-10', TRUE),
('APAGAR', 13,  33, 11,   3300.50, '2025-01-17', TRUE),
('APAGAR', 14,  34, 12,   6100.00, '2025-01-24', TRUE),
('APAGAR', 15,  35, 13,  12500.00, '2025-02-07', TRUE),
('APAGAR', 16,  36, 14,   1750.75, '2025-02-14', TRUE),
('APAGAR', 17,  37,  1,   8700.00, '2025-03-07', TRUE),
('APAGAR', 18,  38,  2,   5500.00, '2025-03-14', TRUE),
('APAGAR', 19,  39,  3,   2300.25, '2025-04-04', TRUE),
('APAGAR', 20,  40,  4,  10200.00, '2025-04-11', TRUE),
-- ARECEBER (20) -----------------------------------------------------------
('ARECEBER',  1, 31, 15,  18000.00, '2024-02-01', TRUE),
('ARECEBER',  2, 32, 16,   9500.50, '2024-03-01', TRUE),
('ARECEBER',  3, 33, 17,  24000.00, '2024-04-01', TRUE),
('ARECEBER',  4, 34, 18,  35000.00, '2024-05-01', TRUE),
('ARECEBER',  5, 35, 19,   8200.00, '2024-06-01', TRUE),
('ARECEBER',  6, 36, 20,  12500.75, '2024-07-01', TRUE),
('ARECEBER',  7, 37, 15,  27000.00, '2024-08-01', TRUE),
('ARECEBER',  8, 38, 16,  16400.00, '2024-09-01', TRUE),
('ARECEBER',  9, 39, 17,  31000.00, '2024-10-01', TRUE),
('ARECEBER', 10, 40, 18,  19800.50, '2024-11-01', TRUE),
('ARECEBER', 11, 31, 19,   7600.00, '2024-12-01', TRUE),
('ARECEBER', 12, 32, 20,  22500.00, '2025-01-01', TRUE),
('ARECEBER', 13, 33, 15,  14000.25, '2025-01-15', TRUE),
('ARECEBER', 14, 34, 16,  41000.00, '2025-02-01', TRUE),
('ARECEBER', 15, 35, 17,  11200.00, '2025-02-15', TRUE),
('ARECEBER', 16, 36, 18,  28500.00, '2025-03-01', TRUE),
('ARECEBER', 17, 37, 19,   6900.75, '2025-03-15', TRUE),
('ARECEBER', 18, 38, 20,  33000.00, '2025-04-01', TRUE),
('ARECEBER', 19, 39, 15,  17800.00, '2025-05-01', TRUE),
('ARECEBER', 20, 40, 16,  25600.00, '2025-06-01', TRUE);
